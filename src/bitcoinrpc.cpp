...
{
    return GetBoolArg("-testnet", false) ? 47676 : 47675;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop YEScoin server (and possibly override the detachdb config value).");
